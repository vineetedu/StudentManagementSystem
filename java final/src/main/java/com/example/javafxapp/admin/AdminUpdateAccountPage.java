...
//page for updating user account information
public class AdminUpdateAccountPage {
    private Stage mainWindow;
    private String adminUsername;

    //show the account update page
    public void show(Stage stage, String user) {
        ...
        //add page title
        Label pageTitle = new Label("Update Account");
        ...
        mainWindow.setTitle("Admin - Update Account");
